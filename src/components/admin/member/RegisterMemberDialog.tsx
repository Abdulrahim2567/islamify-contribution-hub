	...
	<Dialog open={open} onOpenChange={onOpenChange}>
		...
		<DialogContent className="max-w-md dark:bg-background/30 dark:backdrop-blur">
			<div className="text-center mb-8">
				...
				<DialogTitle className="text-2xl font-bold text-gray-900 dark:text-gray-300/80 mb-2">
					Add New Member
				</DialogTitle>
				<DialogDescription>
					Register a new member to the association
				</DialogDescription>
			</div>
			<div className="bg-emerald-50 border border-emerald-200 dark:border-emerald-200/50 dark:bg-emerald-400/5 border-dashed rounded-lg p-4 mb-6">
				...
				<p className="text-xs text-emerald-600 dark:text-emerald-700 mt-1">
					A default password will be generated and must be changed on
					first login.
				</p>
			</div>
			<form onSubmit={onSubmit} className="space-y-6">
				...
				<div>
					<Label className="block text-sm font-medium text-gray-700 dark:text-gray-300/80 mb-3">
						Role
					</Label>
						...
						<button
							...
							className={`flex items-center justify-center space-x-2 p-3 rounded-2xl border-2 transition-all ${
								newMember.role === "member"
									? "border-emerald-500 bg-emerald-50 text-emerald-700 dark:border-emerald-200/30 dark:bg-emerald-400/5"
									: "border-gray-200 dark:border-gray-900 hover:border-gray-300 dark:hover:bg-emerald-400/5 dark:text-gray-300/80"
							}`}
						>
							<User size={20} />
							<span>Member</span>
				...
				<div className="flex space-x-4">
					<Button
						type="button"
						variant="outline"
						className="flex-1 rounded-2xl dark:hover:bg-blue-400/5"
					...
					>
						<Plus size={16} className="mr-2 dark:text-gray-50/90" />
						<span className="dark:text-gray-50/80">Add Member</span>
					</Button>
				</div>
			</form>
		</DialogContent>
