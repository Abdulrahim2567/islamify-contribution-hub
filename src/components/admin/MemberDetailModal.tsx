      ...
      >
        ...
        <div className="flex flex-col items-center justify-center -mt-14 mb-3">
          ...
          <div className="mt-3 flex flex-col items-center">
            ...
            <span className="text-xs font-semibold text-gray-400 tracking-wide uppercase mt-0.5">{member.role}</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col gap-6 px-6 pb-6 overflow-y-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-5 shadow-sm mb-2">
            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3">Contact Information</h3>
            <div className="flex flex-col gap-3 text-gray-700">
              ...
              <div className="flex items-center gap-3 text-sm text-gray-500">
                ...
                <span>
                  Joined on {new Date(member.joinDate).toLocaleDateString(undefined, { year: "numeric", month: "short", day: "numeric" })}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-5 shadow-sm">
            <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-3">Financial Summary</h3>
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                <CreditCard size={20} className="text-emerald-600" />
                <span className="font-semibold text-gray-700 flex-1">Contributions</span>
                <span className="font-bold text-gray-900">{member.totalContributions.toLocaleString()} XAF</span>
              </div>
              <div className="flex items-center gap-3">
                <CreditCard size={20} className="text-indigo-600" />
                <span className="font-semibold text-gray-700 flex-1">Registration Fee</span>
                <span className="font-bold text-gray-900">{member.registrationFee.toLocaleString()} XAF</span>
              </div>
              <div className="flex items-center gap-3">
                <CreditCard size={20} className="text-purple-600" />
                <span className="font-semibold text-gray-700 flex-1">Max Loan</span>
                <span className="font-bold text-gray-900">{(member.totalContributions * 3).toLocaleString()} XAF</span>
              </div>
            </div>
          </div>
        </div>
