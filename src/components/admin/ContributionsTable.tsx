...
const ContributionsTable: React.FC<ContributionsTableProps> = ({
	...
	return (
		<div className="space-y-4">
									...
									<div className="bg-gray-50 p-4 rounded-xl space-y-2">
										{rec.description && (
											<div>
												...
												<p className="text-[12px] text-gray-800 opacity-80 my-3">
													{rec.description}
												</p>
											</div>
										)}
			...
			{totalPages > 0 && (
				<div className="flex sm:flex-row sm:justify-between items-center gap-3 py-3 px-4 border-t border-gray-100 bg-white/90">
